...
SECRET_KEY = SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "fallback-secret-key-for-dev-only")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,192.168.12.57").split(",")
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'common.context_processors.breadcrumb', # Uncomment if you have a breadcrumb context processor
            ],
        },
    },
]
...
DATABASES = {
    ...
    #     'HOST': 'postgres', # postgres host is name of service in docker-compose.yml
...
# Optional: สำหรับ collectstatic ใน production
STATICFILES_DIRS = [
    BASE_DIR / "static",  # สำหรับ global static
]
